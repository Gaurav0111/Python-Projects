...
def upload_to_drive():
    headers = {"Authorization": "Bearer 'Authorization keys'   "}
    file_name = ""
...
checkbutton1 = Checkbutton(win, text="Material_1",variable=button1,onvalue=1,offvalue=0,height=2,width=30,command=Material_1)
checkbutton1.grid(row=14,column=2)

checkbutton2 = Checkbutton(win , text="Material_2",variable=button2,onvalue=1,offvalue=0,height=2,width=20,command=Material_2)
